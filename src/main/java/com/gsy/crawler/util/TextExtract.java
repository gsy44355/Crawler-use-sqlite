 ...
 */
/**
 *  获取网页正文，但是目前来看，测试效果不是很好，这个只是对当时的小说页面有效，估计等以后有需求了才可以真正使用
 *  调用静态方法，传入的html字段应该用WebCrawlerUtil.getWebHtmlWithNewLine 保证有换行，这个代码才可以正常运行
 *
 *  目前自己有代码直接将文本到文件，但是没想好这几个工程之间的关系，所以如果后续有需求再进行开发
 */
...
//		System.out.println(html);
    ...
    private static void preProcess() {
        ...
        html = html.replaceAll("p class=\"font_gray_1\">.*?</p>","");
